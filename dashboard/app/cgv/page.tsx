      ...
      <div className="container mx-auto px-4 py-12 max-w-4xl">
        ...
        <div className="bg-gray-800/50 rounded-lg p-8 space-y-8">
          ...
          <section>
            ...
            <div className="bg-gray-700/50 rounded-lg p-4">
              <p className="text-gray-300 leading-relaxed mb-3">
                ...
                Support : <a href="https://discord.gg/community-intelligence" target="_blank" rel="noopener noreferrer" className="text-blue-400 hover:text-blue-300 underline">Serveur Discord de support</a><br />
                <br />
            ...
            <div className="bg-blue-600/20 border border-blue-500 rounded-lg p-4">
              ...
              <div className="mt-3">
                <p className="text-gray-300 text-sm mb-3">
                  ...
                  Rejoignez notre serveur Discord de support et créez un ticket avec votre numéro de commande ou ID de serveur Discord.
                </p>
                <a
            ...
            <div className="bg-gray-700/50 rounded-lg p-4 space-y-3">
              <div>
                ...
                <p className="text-gray-300 text-sm mt-2 mb-3">
                  ...
                  via notre serveur Discord de support.
                </p>
                <a
                  href="https://discord.gg/community-intelligence"
                  target="_blank"
          ...
          <section>
            ...
            <div className="bg-blue-600/20 border border-blue-500 rounded-lg p-4">
              <p className="text-gray-300 leading-relaxed mb-3">
                Pour toute question concernant les présentes CGV ou pour exercer vos droits, contactez-nous via notre serveur Discord de support :
              </p>
              <a
                href="https://discord.gg/community-intelligence"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 hover:bg-blue-700 rounded-lg transition-colors text-white font-semibold mb-3"
              >
